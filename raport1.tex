...
Przed rzeczywistą realizacją projektu w środowisku Simulink zrealizowano model silnika prądu stałego (Rysunek ref), zgodnie z metodyką przedstawioną w skrypcie do ćwiczenia \cite{ekurs}. Parametry silnika zadeklarowano w niezależnym skrypcie w środowisku MATLAB, jak przedstawiono w Listing \ref{lst:silnik}.
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\textwidth,trim=0cm 5cm 0cm 5cm,clip]{model.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\textwidth]{przebiegi1.pdf}
...
Na rysunku \ref{fig:przebiegi1} przedstawiona jest dynamika rozruchu modelu maszyny przy skokowym wymuszeniu. Wymuszeniem jest napięcie twornika o wartości $U_a = 240$ V. 
